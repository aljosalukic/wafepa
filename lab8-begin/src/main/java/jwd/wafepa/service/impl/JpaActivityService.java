...
public class JpaActivityService 
	...
	public Page<Activity> findAll(int page) {
		return activityRepository.findAll(new PageRequest(page, 10000));
	}
	...
	@Override
	public List<Activity> findByDescription(String name) {
		
		return activityRepository.findByDescriptionLike(name);
	}
